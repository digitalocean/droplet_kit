...
module DropletKit
  ...
  autoload :DatabaseCluster, 'droplet_kit/models/database_cluster'
  autoload :Database, 'droplet_kit/models/database'
  autoload :DatabaseClusterReplica, 'droplet_kit/models/database_cluster_replica'
  ...
  autoload :DatabaseClusterConnectionPool, 'droplet_kit/models/database_cluster_connection_pool'
  ...
  autoload :DatabaseClusterMapping, 'droplet_kit/mappings/database_cluster_mapping'
  autoload :DatabaseMapping, 'droplet_kit/mappings/database_mapping'
  autoload :DatabaseClusterReplicaMapping, 'droplet_kit/mappings/database_cluster_replica_mapping'
  autoload :DatabaseClusterUserMapping, 'droplet_kit/mappings/database_cluster_user_mapping'
  autoload :DatabaseClusterSQLModeMapping, 'droplet_kit/mappings/database_cluster_sql_mode_mapping'
  ...
  autoload :DatabaseClusterFirewallRulesMapping, 'droplet_kit/mappings/database_cluster_firewall_rules_mapping'
  autoload :DatabaseClusterEvictionPolicyMapping, 'droplet_kit/mappings/database_cluster_eviction_policy_mapping'
  autoload :DatabaseClusterConnectionMapping, 'droplet_kit/mappings/database_cluster_connection_mapping'
  autoload :DatabaseClusterConnectionPoolMapping, 'droplet_kit/mappings/database_cluster_connection_pool_mapping'
