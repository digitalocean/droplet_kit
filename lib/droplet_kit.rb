...
module DropletKit
  ...
  autoload :Drive, 'droplet_kit/models/drive'
  ...
  autoload :DriveResource, 'droplet_kit/resources/drive_resource'
  autoload :DriveActionResource, 'droplet_kit/resources/drive_action_resource'
  ...
  autoload :DriveMapping, 'droplet_kit/mappings/drive_mapping'
